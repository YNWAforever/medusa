...
export interface PhotoAssetView { id: string; display_name: string; expected_bytes: number; stored_bytes?: number | null; detected_mime_type?: string | null; status: PhotoAssetStatus; failure_code?: string | null }
export interface PhotoJobView { id: string; locale: "en" | "zh-HK"; status: PhotoJobStatus; revision: number; assets?: PhotoAssetView[] }
...
export type PhotoErrorCode = "photo_job_not_found" | "photo_job_unavailable" | "photo_upload_expired" | "photo_upload_not_active" | "photo_file_too_large" | "photo_asset_limit_exceeded" | "photo_job_bytes_exceeded" | "photo_upload_failed"
