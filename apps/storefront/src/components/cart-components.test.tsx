...
describe("Fotomax cart and service composition", () => {
  ...
  it("uses explicit clear confirmation and provider-owned drawer visibility contracts", () => {
    ...
    expect(providerSource).toContain("isResettableCart(error.code)")
    expect(providerSource).toContain('code === "cart_expired"')
    expect(providerSource).toContain('code === "cart_unrecoverable"')
