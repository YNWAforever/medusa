...
describe("Fotomax catalog page composition", () => {
  ...
  it("renders variants as product details and uses the live price", () => { const markup = renderCatalog("en").product; expect(markup).toContain("Paper finish"); expect(markup).toContain("Glossy"); expect(markup).toContain("Matte"); expect(markup).toContain("HK$"); expect(markup).toContain('class="option-stack"') })
