...
import { createCustomerAuthSdk, listCustomerOrders } from "../../../../src/lib/medusa/auth"
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ orders: await listCustomerOrders(sdk) })
  } catch (error) {
    ...
    return NextResponse.json({ error: { code: "orders_unavailable" } }, { status: 502 })
  }
}
