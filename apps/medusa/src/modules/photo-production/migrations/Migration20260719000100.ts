...
export class Migration20260719000100 extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'update "photo_upload_session" as s set "source_idempotency_key" = a."job_id" || \':\' || s."source_idempotency_key" from "photo_asset" as a where s."asset_id" = a."id" and s."source_idempotency_key" not like a."job_id" || \':%\';',
    );
    this.addSql(
