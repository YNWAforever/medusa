...
Task 8: complete (commits 1c96792, 890b1b0, e2de025; final-review continuation adds SSR language coverage, empty-state recovery, strict workflow seed DTOs, and root Medusa/Admin build coverage; 85 unit tests, 18 Playwright journeys, clean-start server ownership, and both production builds pass)
