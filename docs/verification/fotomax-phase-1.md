...
- Controller browser verification found the original localized-404 and LCP-warning gaps. This automated fix pass does not claim a second in-app visual review; the controller owns the final preview.
