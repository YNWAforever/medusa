...
export const products: Product[] = [
  { handle: "classic-4r-photo-print", categoryHandle: "photo-print", status: "featured", commerceMode: "photo_print", name: { "zh-HK": "經典 4R 相片沖印", en: "Classic 4R Photo Print" }, description: { "zh-HK": "適合家庭、旅行及日常分享的標準尺寸相片沖印。", en: "Standard-size prints for family, travel, and everyday sharing." }, image: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=1200&q=80", priceCents: 280, badge: { "zh-HK": "人氣服務", en: "Popular service" }, options: [{ name: { "zh-HK": "相紙", en: "Paper finish" }, values: [{ "zh-HK": "光面", en: "Glossy" }, { "zh-HK": "啞面", en: "Matte" }] }] },
  { handle: "premium-layflat-photobook", categoryHandle: "photobook", status: "featured", commerceMode: "deferred", name: { "zh-HK": "高級平開相簿", en: "Premium Layflat Photobook" }, description: { "zh-HK": "適合婚禮、旅行及家庭故事的平開設計相簿。", en: "A layflat book for weddings, travel, and family stories." }, image: "https://images.unsplash.com/photo-1528569937393-ee892b976859?auto=format&fit=crop&w=1200&q=80", priceCents: 19800, badge: { "zh-HK": "可客製", en: "Customizable" }, options: [{ name: { "zh-HK": "尺寸", en: "Size" }, values: [{ "zh-HK": "8 x 8 吋", en: "8 x 8 in" }, { "zh-HK": "10 x 10 吋", en: "10 x 10 in" }] }] },
  { handle: "photo-mug-gift", categoryHandle: "personalized-gifts", status: "available", commerceMode: "deferred", name: { "zh-HK": "個人化相片杯", en: "Personalized Photo Mug" }, description: { "zh-HK": "把喜愛相片印在日常使用的陶瓷杯上。", en: "Print a favorite image on an everyday ceramic mug." }, image: "https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?auto=format&fit=crop&w=1200&q=80", priceCents: 8800, badge: { "zh-HK": "送禮精選", en: "Gift pick" }, options: [{ name: { "zh-HK": "杯色", en: "Mug color" }, values: [{ "zh-HK": "白色", en: "White" }, { "zh-HK": "黑色", en: "Black" }] }] },
  { handle: "instax-mini-film-pack", categoryHandle: "instax-film", status: "available", commerceMode: "retail", name: { "zh-HK": "Instax Mini 即影即有菲林", en: "Instax Mini Film Pack" }, description: { "zh-HK": "適用於 Instax Mini 系列相機的即影即有菲林。", en: "Instant film for Instax Mini cameras." }, image: "https://images.unsplash.com/photo-1486574655068-162e94137442?auto=format&fit=crop&w=1200&q=80", priceCents: 7800, badge: { "zh-HK": "門市取貨", en: "Store pickup" }, options: [{ name: { "zh-HK": "包裝", en: "Pack" }, values: [{ "zh-HK": "10 張", en: "10 shots" }, { "zh-HK": "20 張", en: "20 shots" }] }] },
  { handle: "desktop-acrylic-photo-block", categoryHandle: "lifestyle", status: "available", commerceMode: "deferred", name: { "zh-HK": "亞加力座枱相架", en: "Desktop Acrylic Photo Block" }, description: { "zh-HK": "清晰厚身亞加力展示相片，適合家居或辦公桌。", en: "A clear acrylic block for desks, shelves, and workspaces." }, image: "https://images.unsplash.com/photo-1526049471490-b2a136bb4538?auto=format&fit=crop&w=1200&q=80", priceCents: 12800, badge: { "zh-HK": "家居擺設", en: "Home display" }, options: [{ name: { "zh-HK": "方向", en: "Orientation" }, values: [{ "zh-HK": "直度", en: "Portrait" }, { "zh-HK": "橫度", en: "Landscape" }] }] },
]
